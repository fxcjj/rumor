 ...
 */
@Slf4j
public class GenTable2EntityUtils {
    /**
     * 这里是MySQL连接方法
     */
    ...
    private static final String URL = "jdbc:mysql://10.50.21.241:4000/security_watch_dev" + "?user=" + USERNAME + "&password=" + PASSWORD + "&useUnicode=true&characterEncoding=UTF-8";
    ...
    public static void main(String[] args) {
        ...
        /*for (String col : getColumnTypes(t)) {
            System.out.println(col);
        }*/
        for (String col : getColumnComments(t)) {
            System.out.println(col);
        }
